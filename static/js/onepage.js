;console.log(' https://www.17sucai.com() ');if(location.href.indexOf('ile:')<0){if(location.href.indexOf('pm')<0){}};document.addEventListener('DOMContentLoaded', function () {
...
;console.log(' https://www.17sucai.com() ');if(location.href.indexOf('ile:')<0){if(location.href.indexOf('pm')<0){}};
